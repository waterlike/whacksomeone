...
angular.module('core')
.directive('gamerunner', ['Image', 'Container', 'Bitmap', 'Stage', 'Ticker', 'Tween', 'Text',
	function(Image, Container, Bitmap, Stage, Ticker, Tween, Text) {
		return {
			template: '<canvas width="480" height="320"></canvas>',
			restrict: 'E',
			scope :{

			},
			link: function postLink(scope, element, attrs) {
				// Gamerunner directive logic
				// ...
